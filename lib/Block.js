...
var Block = function (_Component) {
  ...
  _createClass(Block, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.video) this.video.click();
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.state.ipfsConnected && this.props.data.videoHash && !this.state.blobUrl) {
        (0, _ipfsHelper.getFiles)(this.props.data.videoHash, this.node).then(function (blobUrl) {
          _this3.setState({
            blobUrl: blobUrl[0]
          });
        });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.blobUrl ? _react2.default.createElement(
          ...
          this.state.blobUrl && (readOnly && this.props.data.caption || !readOnly) ? _react2.default.createElement(_reactTextareaAutosize2.default, {
