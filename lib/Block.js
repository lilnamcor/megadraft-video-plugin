...
var Block = function (_Component) {
  ...
  _createClass(Block, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.video && !this.state.videoClicked && !this.props.blockProps.getInitialReadOnly() && this.textArea) {
        this.video.click();
        this.textArea.focus();
        this.setState({
          videoClicked: true
          ...
          _react2.default.createElement(
            ...
            this.props.data.videoSrc ? _react2.default.createElement(
              _reactPopover2.default,
              {
                ...
                body: _react2.default.createElement(_VideoPopover2.default, { changeWidth: this.changeWidth, width: this.props.data.width }),
                preferPlace: "above",
                place: "column",
